    ...
    if results.multi_hand_landmarks:
        ...
        if len(landmarks) == 21:
            ...
            if distancex[6] < distancex[10] < distancex[14] < distancex[18] and \
                    (distancex[10] - distancex[6] < 50) and (distancex[14] - distancex[10] < 50) and (
                    distancex[18] - distancex[14] < 50) and \
            ...
            if ((distancey[4] < distancey[5]) & (distancex[5] - distancex[9] > 0) & (
                    distancex[5] - distancex[9] < 20) & (distancex[4] - distancex[8] < 20)):
            ...
            if ((distancey[4] - distancey[8] > 100) & (distancey[4] - distancey[8] < 130) & (
                    distancex[0] - distancex[4] > 125) & (distancey[0] - distancey[4] < 40)):
